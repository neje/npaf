...
public:
  /**
   * Create an StatsSourceHelper to make it easier to work with OnOffApplications
   *
  ...
  /**
   * Install an ns3::StatsPacketSource on each node of the input container
   * configured with all the attributes set with SetAttribute.
   *
   * \param c NodeContainer of the set of nodes on which an StatsPacketSource 
   * will be installed.
  ...
  /**
   * Install an ns3::StatsPacketSource on the node configured with all the 
   * attributes set with SetAttribute.
   *
   * \param node The node on which an StatsPacketSource will be installed.
   * \returns Container of Ptr to the applications installed.
   */
   ...
   * attributes set with SetAttribute.
   *
   * \param nodeName The node on which an StatsPacketSource will be installed.
   * \returns Container of Ptr to the applications installed.
   */
  ...
  * \param c NodeContainer of the set of nodes for which the StatsPacketSource
