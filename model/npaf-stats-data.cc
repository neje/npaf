...
FlowData::Finalize ()
{
  ...
  Summary s;
  Time endOfTransmition = (m_scalarData.lastPacketSent - m_scalarData.lastPacketReceived > Time (0))
...
StatsFlows::Finalize ()
{
  ...
  Time endOfTransmition = (m_allPacketsStats.lastPacketSent - m_allPacketsStats.lastPacketReceived > Time (0))
